...
QString ApplicationAdaptor::GetApplicationBusAddress()
{
    // handle method call org.a11y.atspi.Application.GetApplicationBusAddress
    return parent()->GetApplicationBusAddress();
}
