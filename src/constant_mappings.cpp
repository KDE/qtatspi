...
static void initialize_role_mapping ()
{
       ...
       qSpiRoleMapping.insert (QAccessible::Client, ROLE_FRAME);
       ...
       qSpiRoleMapping.insert (QAccessible::Pane, ROLE_FRAME);
       ...
       qSpiRoleMapping.insert (QAccessible::Column, ROLE_TABLE);
       qSpiRoleMapping.insert (QAccessible::Row, ROLE_TABLE);
       ...
       qSpiRoleMapping.insert (QAccessible::TreeItem, ROLE_LIST_ITEM);
       qSpiRoleMapping.insert (QAccessible::PageTab, ROLE_PAGE_TAB);
       qSpiRoleMapping.insert (QAccessible::PropertyPage, ROLE_PANEL);
       ...
       qSpiRoleMapping.insert (QAccessible::ButtonDropDown, ROLE_COMBO_BOX);
       qSpiRoleMapping.insert (QAccessible::ButtonMenu, ROLE_COMBO_BOX);
       qSpiRoleMapping.insert (QAccessible::ButtonDropGrid, ROLE_COMBO_BOX);
       qSpiRoleMapping.insert (QAccessible::Whitespace, ROLE_SEPARATOR);
       qSpiRoleMapping.insert (QAccessible::PageTabList, ROLE_FRAME);
       qSpiRoleMapping.insert (QAccessible::Clock, ROLE_UNKNOWN);
       qSpiRoleMapping.insert (QAccessible::Splitter, ROLE_SEPARATOR);
